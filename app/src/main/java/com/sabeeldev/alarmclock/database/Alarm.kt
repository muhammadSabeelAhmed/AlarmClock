...
import com.sabeeldev.alarmclock.MainApp
...
data class Alarm(@PrimaryKey(autoGenerate = true) var aid: Long = 0,
                 ...
                 @ColumnInfo(name = "days") var days: LinkedHashMap<String, Boolean> = linkedMapOf(
                     MainApp.applicationContext().resources.getString(R.string.alarm_days_monday) to true,
    ...
    val daysStringToCalendar = hashMapOf(
        MainApp.applicationContext().resources.getString(R.string.alarm_days_monday) to Calendar.MONDAY,
